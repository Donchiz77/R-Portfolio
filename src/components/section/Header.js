...
const Header = () => {
    ...
    return (
        <div>
            ...
            <p className="line-1 anim-typewriter">and welcome to my portfolio... </p>
            ...
            <img id="not-dark" onClick={scrollTo} alt="Contact Me" title="Contact Me" className="gtp" src="IMG_20211009_024156_01.png"></img>
        </div>
    )
